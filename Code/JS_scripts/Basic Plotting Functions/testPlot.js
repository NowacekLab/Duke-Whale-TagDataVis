...
const dataFrame = dfd.read_csv(calc_file_str);

// Dpeth vs Time Plot
MYDIV = document.getElementById('myDiv');
Plotly.newPlot(MYDIV, getJSONOneLine(dataFrame, "Time", "Depth"));

// Pitch vs Time Plot
MYDIV = document.getElementById('myDiv');
Plotly.newPlot(MYDIV, getJSONOneLine(dataFrame, "Time", "Pitch"));

// Roll vs Time Plot
MYDIV = document.getElementById('myDiv');
Plotly.newPlot(MYDIV, getJSONOneLine(dataFrame, "Time", "Roll"));

// Heading vs Time Plot
MYDIV = document.getElementById('myDiv');
Plotly.newPlot(MYDIV, getJSONOneLine(dataFrame, "Time", "Heading"));
"""
modwt.py creates a Python version of Matlab's modwt() and related functions

This code is credited to pistonly who owns the Github repository for modwtpy
modwt.py was originally coded by pistonly and is recreated here.
The link to the source is as follows: https://github.com/pistonly/modwtpy.git 
"""

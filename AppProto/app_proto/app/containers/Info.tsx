...
const Info = () => {
  ...
  const information: Array<Record<string, string>> = [
    {
  ...
  return (
    <Container className={classes.root}>
      <p className={classes.header}>Info</p>
      <div className={classes.bodyContainer}>
        ...
        {information.map((obj) => {
          return (
            <Accordion className={classes.accordion} key={obj['title']}>
              <AccordionSummary
                expandIcon={<ExpandMoreIcon style={{color: "white"}} />}
              >

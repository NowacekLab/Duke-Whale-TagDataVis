...
def video_exporter(calc_file_path: str, target_dir: str): 
    # try:
    ...
    new_name = f"{os.path.basename(calc_file_path)}_animated"
    new_path = os.path.join(target_dir, new_name)
    
    # anim.save(new_path, writer=writer)
    anim.save(new_path)
    
def export_video_single(file_path: str, target_dir: str):
  return export_single_generic(video_exporter, file_path, target_dir)